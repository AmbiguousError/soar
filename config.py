...
STATE_GAME_OVER = 10 # General game over, might need specific one for dogfight if different flow
STATE_PAUSED = 11
STATE_RACE_POST_OPTIONS = 12
STATE_DOGFIGHT_PLAYING = 13
STATE_DOGFIGHT_ROUND_COMPLETE = 14
STATE_DOGFIGHT_GAME_OVER_CONTINUE = 15 # Screen to ask if player wants to try round again
...
# --- Game Mode ---
MODE_FREE_FLY = 0; MODE_RACE = 1; MODE_DOGFIGHT = 2 # New game mode
