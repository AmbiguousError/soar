...
# AI Colors (Body, Wing) - Ensure these are distinct from player and markers
AI_GLIDER_COLORS_LIST = [
    ((250, 180, 180), (255, 200, 200)), # Reddish
    ((180, 250, 180), (200, 255, 200)), # Greenish (distinct from target green)
    ((200, 180, 250), (220, 200, 255)), # Purplish
    ((250, 250, 180), (255, 255, 200)), # Yellowish
    ((180, 230, 250), (200, 240, 255)), # Light Blue
    ((220, 220, 220), (235, 235, 235)), # Light Gray
]

# Wingman Specific
MAX_WINGMEN = 5 # Maximum number of wingmen that can be unlocked
WINGMAN_FOLLOW_DISTANCE_X = -80 # Target X offset behind player
WINGMAN_FOLLOW_DISTANCE_Y_BASE = 60 # Base Y offset to the side
WINGMAN_FORMATION_SPREAD = 40 # Additional Y spread per wingman
WINGMAN_CASUALNESS_FACTOR = 0.05 # How loosely they follow (lower is tighter)
...
STATE_GAME_OVER = 10
STATE_PAUSED = 11
STATE_RACE_POST_OPTIONS = 12 # New state for after race completion
