...
MAX_BANK_ANGLE = 45
BANK_RATE = 2
# New base turn rate: Normal difficulty will have a ~100% larger turning circle (half the turn rate)
BASE_PLAYER_BANK_TO_DEGREES_PER_FRAME = 0.06 
NOOB_TURN_FACTOR = 2.0    # N00b turns ~100% faster than new Normal (similar to old Normal)
EASY_TURN_FACTOR = 1.5    # Easy turns ~50% faster than new Normal
NORMAL_TURN_FACTOR = 1.0  # New Normal turn rate (larger turning circle)
...
# --- Game States ---
STATE_START_SCREEN = 0; STATE_DIFFICULTY_SELECT = 1; STATE_MODE_SELECT = 2; STATE_PLAYING_FREE_FLY = 3
STATE_TARGET_REACHED_OPTIONS = 4; STATE_TARGET_REACHED_CONTINUE_PLAYING = 5; STATE_POST_GOAL_MENU = 6
STATE_RACE_LAPS_SELECT = 7; STATE_RACE_PLAYING = 8; STATE_RACE_COMPLETE = 9; STATE_GAME_OVER = 10
STATE_PAUSED = 11; STATE_RACE_POST_OPTIONS = 12
